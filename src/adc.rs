        ...
        $(
            ...
            impl DynamicAdc<stm32::$adc_type> {
                ...
                pub fn set_resolution(&mut self, resolution: config::Resolution) {
                    ...
                    self.adc_reg.cfgr().modify(|_, w| unsafe{w.res().bits(resolution.into());});
                }
                ...
                fn set_subgroup_len(&mut self, subgroup_len: config::SubGroupLength) {
                    ...
                    self.adc_reg.cfgr().modify(|_, w| unsafe{w.discnum().bits(subgroup_len as u8);})
                }
                    ...
                    CHANNEL: Channel<stm32::$adc_type, ID=u8>
                {
                    ...
                    match channel {
                        0 => self.adc_reg.smpr1().modify(|_, w| unsafe{w.smp0().bits(st);} ),
                        1 => self.adc_reg.smpr1().modify(|_, w| unsafe {w.smp1().bits(st);} ),
                        2 => self.adc_reg.smpr1().modify(|_, w| unsafe{w.smp2().bits(st);} ),
                        3 => self.adc_reg.smpr1().modify(|_, w| unsafe{w.smp3().bits(st);} ),
                        4 => self.adc_reg.smpr1().modify(|_, w| unsafe{w.smp4().bits(st);} ),
                        5 => self.adc_reg.smpr1().modify(|_, w| unsafe{w.smp5().bits(st);} ),
                        6 => self.adc_reg.smpr1().modify(|_, w| unsafe{w.smp6().bits(st);} ),
                        7 => self.adc_reg.smpr1().modify(|_, w| unsafe{w.smp7().bits(st);} ),
                        8 => self.adc_reg.smpr1().modify(|_, w| unsafe{w.smp8().bits(st);} ),
                        9 => self.adc_reg.smpr1().modify(|_, w| unsafe{w.smp9().bits(st);} ),
                        10 => self.adc_reg.smpr2().modify(|_, w| unsafe{w.smp10().bits(st);} ),
                        11 => self.adc_reg.smpr2().modify(|_, w| unsafe{w.smp11().bits(st);} ),
                        12 => self.adc_reg.smpr2().modify(|_, w| unsafe{w.smp12().bits(st);} ),
                        13 => self.adc_reg.smpr2().modify(|_, w| unsafe{w.smp13().bits(st);} ),
                        14 => self.adc_reg.smpr2().modify(|_, w| unsafe{w.smp14().bits(st);} ),
                        15 => self.adc_reg.smpr2().modify(|_, w| unsafe{w.smp15().bits(st);} ),
                        16 => self.adc_reg.smpr2().modify(|_, w| unsafe{w.smp16().bits(st);} ),
                        17 => self.adc_reg.smpr2().modify(|_, w| unsafe{w.smp17().bits(st);} ),
                        18 => self.adc_reg.smpr2().modify(|_, w| unsafe{w.smp18().bits(st);} ),
                        _ => unimplemented!(),
                    }
                }
